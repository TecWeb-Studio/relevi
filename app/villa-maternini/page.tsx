        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="reveal bg-white rounded-3xl shadow-xl border border-olive-100 p-8 md:p-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              Healing porta le proprie attività di benessere, workshop e eventi
              speciali. La villa offre un ambiente suggestivo e accogliente,
              perfetto per esperienze di crescita personale e comunitaria.
            </p>
            <p className="text-gray-700 leading-relaxed">
              La sinergia tra Relevi Healing e Villa Maternini nasce dalla
              condivisione di valori comuni: attenzione alla persona, rispetto
              per la natura e la cultura del territorio, e l&apos;impegno nel
              creare momenti di valore per la comunità.
            </p>
          </div>
        </div>
      </section>

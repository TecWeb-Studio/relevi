...
export default function ServicesPage() {
  ...
  const services: Service[] = [
    { id: 1, key: 'swedishMassage', icon: '🌿', recommended: true },
    { id: 2, key: 'deepTissue', icon: '💆', recommended: true },
    { id: 3, key: 'hotStoneTherapy', icon: '🔥', recommended: false },
    { id: 4, key: 'aromatherapy', icon: '🌸', recommended: false },
    { id: 5, key: 'sportsMassage', icon: '🏃', recommended: true },
    { id: 6, key: 'reflexology', icon: '👣', recommended: false },
    { id: 7, key: 'prenatalMassage', icon: '🤰', recommended: false },
    { id: 8, key: 'couplesMassage', icon: '👫', recommended: true },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center reveal">
            <h1 className="text-5xl md:text-6xl font-bold text-olive-800 mb-6">
              {t('services.hero.title').split(t('services.hero.title').includes('Services') ? 'Services' : 'Servizi')[0]}
              <span className="text-gradient">
                {t('services.hero.title').includes('Services') ? 'Services' : 'Servizi'}
              </span>
            </h1>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-olive-100">
                    <div>
                      <p className="text-sm text-gray-500">{t('services.duration')}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((pkg, idx) => (
              ...
              >
                ...
                <div className="mb-6">
                  {(t(`services.packages.${pkg.key}.services`, { returnObjects: true }) as string[]).map((service: string) => (
                    <div
                      key={service}
                ...
                >
                  {t(`services.packagePrices.${pkg.key}`)}
                </div>
            ...
            <div className="p-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  {t(`services.serviceTypes.${selectedService.key}.fullDescription`)}
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="grid grid-cols-2 gap-3">
                  {(t(`services.serviceTypes.${selectedService.key}.benefits`, { returnObjects: true }) as string[]).map((benefit: string) => (
                    <li
                      key={benefit}
              ...
              <div className="grid grid-cols-3 gap-4 mb-6 p-4 bg-olive-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-bold text-olive-700">
                    {t(`services.prices.${selectedService.key}`)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">{t('services.modal.therapists')}</p>
                  <p className="font-bold text-olive-700">{t('services.modal.specialized')}</p>
                </div>
              </div>

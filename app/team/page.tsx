...
export default function TeamPage() {
  ...
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      id: 9,
      key: "dariaBonora",
      image: "/team-photos-crop/DariaBonora.png",
    },
    {
      id: 10,
      key: "giadaGiacomini",
              ...
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-10 flex flex-col justify-center">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {(
                      t("team.members.headmaster.specialties", {
                        returnObjects: true,
                      }) as string[]
                    )
                      .slice(0, 3)
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {(
                      t(`team.members.${member.key}.specialties`, {
                        returnObjects: true,
                      }) as string[]
                    )
                      .slice(0, 2)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover-lift">
                ...
                <p className="text-gray-600">
                  {t("team.stats.combinedExperience")}
                </p>
              </div>
              <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover-lift">
          ...
          >
            ...
            <div className="p-8">
              ...
              <p className="text-olive-600 text-lg mb-6">
                {t(`team.members.${selectedMember.key}.role`)}
              </p>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  {t(`team.members.${selectedMember.key}.bio`)}
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {(
                    t(`team.members.${selectedMember.key}.specialties`, {
                      returnObjects: true,
                    }) as string[]
                  ).map((specialty: string) => (
                    <span
              ...
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-olive-800 mb-2">
                  {t("team.modal.certifications")}
                </h3>
                <ul className="space-y-2">
                  {(
                    t(`team.members.${selectedMember.key}.certifications`, {
                      returnObjects: true,
                    }) as string[]
                  ).map((cert: string) => (
                    <li
